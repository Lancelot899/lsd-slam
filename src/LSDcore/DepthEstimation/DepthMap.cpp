...
{
	threadReducer.reduce(boost::bind(&DepthMap::observeDepthRow, this, _1, _2), 3, height-3, 10);
}
...
void DepthMap::regularizeDepthMapFillHoles()
{
	...
	threadReducer.reduce(boost::bind(&DepthMap::regularizeDepthMapFillHolesRow, this, _1, _2), 3, height-2, 10);
}
...
{
	threadReducer.reduce(boost::bind(&DepthMap::buildRegIntegralBufferRow1, this, _1, _2), 0, height);
...
void DepthMap::regularizeDepthMap(bool removeOcclusions, int validityTH)
{
	...
	if(removeOcclusions)
		threadReducer.reduce(boost::bind(&DepthMap::regularizeDepthMapRow<true>, this, validityTH, _1, _2), 2, height-2, 10);
	else
		threadReducer.reduce(boost::bind(&DepthMap::regularizeDepthMapRow<false>, this, validityTH, _1, _2), 2, height-2, 10);
}
